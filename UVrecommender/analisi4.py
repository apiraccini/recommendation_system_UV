...
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = GD.gradient_descent_mat(utility, d = d, eta = etaGD, perturb = False, init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("GD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD.stochastic_gradient_descent_mat(utility, d = d, eta = etaSGD, perturb = False, init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD2.stochastic_gradient_descent_mat2(utility, d = d, eta = etaSGD2, perturb = False, init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD2\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
...
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = GD.gradient_descent_mat(utility, d = d, eta = etaGD, perturb = True, nperturb = nperturb, method = "n", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("GD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD.stochastic_gradient_descent_mat(utility, d = d, eta = etaSGD, perturb = True, nperturb = nperturb, method = "n", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD2.stochastic_gradient_descent_mat2(utility, d = d, eta = etaSGD2, perturb = True, nperturb = nperturb, method = "n", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD2\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
...
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = GD.gradient_descent_mat(utility, d = d, eta = etaGD, perturb = True, nperturb = nperturb, method = "u", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("GD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD.stochastic_gradient_descent_mat(utility, d = d, eta = etaSGD, perturb = True, nperturb = nperturb, method = "u", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
time.sleep(1)
t1 = dt.datetime.now()
U, V, rmse, num_iter, perc_corretti = SGD2.stochastic_gradient_descent_mat2(utility, d = d, eta = etaSGD2, perturb = True, nperturb = nperturb, method = "u", init = "ones")
t2 = dt.datetime.now()
delta = t2 - t1
f.write("SGD2\t\t{}\t\t{}%\t\t\t{}\t\t{}\n".format(np.round(rmse,5), np.round(perc_corretti,2), num_iter, delta)) 
